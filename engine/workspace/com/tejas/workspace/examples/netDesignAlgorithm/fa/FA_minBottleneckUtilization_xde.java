...
/**
 * <p>Given a network topology, the capacities in the links and the offered traffic, this algorithm obtains the traffic routing that minimizes the network congestion,
 * with or without the constraint of non-bifurcated routing.</p>
 *
 * <p>In this algorithm, congestion is minimized by minimizing the utilization in the bottleneck (the link with highest utilization).</p>
 *
 * @author Pablo Pavon-Marino, Jose-Luis Izquierdo-Zaragoza
 * @version 1.0, March 2013
 */
public class FA_minBottleneckUtilization_xde implements IAlgorithm
{
	@Override
	public String executeAlgorithm(NetPlan netPlan, Map<String, String> algorithmParameters, Map<String, String> net2planParameters)
	{
		...
		op.addConstraint("h_d * x_de <= rho * u_e"); // computing the traffic in each link (E constraints)
...
//	for (int e = 0 ; e < E ; e ++)
//		op.addConstraint("h_d * x_de(all," + e + ") <= " + u_e[e] + " * rho");
	...
	public String getDescription()
	{
		...
		aux.append("Given a network topology, the capacities in the links and the offered traffic, this algorithm obtains the traffic routing " +
				...
				"minimized by minimizing the utilization in the bottleneck (the link with highest utilization).");
		return aux.toString();
	}
