...
/**
 * <p>Contract that must be fulfilled such that a report can be run in <code>Net2Plan</code>.</p>
 *
 * <p>Integration of new reports follows a similar scheme as for {@link com.tejas.engine.interfaces.networkDesign.IAlgorithm IAlgorithm}.</p>
 *
