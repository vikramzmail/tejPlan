...
public class FullScrollPaneLayout extends ScrollPaneLayout
{
    ...
    {
        if(c == hleft)      hleft = null;
        else if(c==hright)  hright = null;
        else if(c==vtop)    vtop = null;
        else if(c==vbottom) vbottom = null;
    ...
    {
        if (!(parent instanceof JScrollPane)) throw new RuntimeException("Bad - Not a JScrollPane instance");
	...
	else
	{
        ...
        if(isEmpty) vsbNeeded = false;
        else if(vsbPolicy == VERTICAL_SCROLLBAR_ALWAYS) vsbNeeded = true;
        else if(vsbPolicy == VERTICAL_SCROLLBAR_NEVER)  vsbNeeded = false;
        else vsbNeeded = !viewTracksViewportHeight && (viewPrefSize.height > extentSize.height);
        ...
        if((vsb != null) && vsbNeeded)
	{
        ...
        boolean hsbNeeded;
        if(isEmpty) hsbNeeded = false;
        else if(hsbPolicy == HORIZONTAL_SCROLLBAR_ALWAYS) hsbNeeded = true;
        else if(hsbPolicy == HORIZONTAL_SCROLLBAR_NEVER)  hsbNeeded = false;
	else hsbNeeded = !viewTracksViewportWidth && (viewPrefSize.width > extentSize.width);
        ...
        if((hsb != null) && hsbNeeded)
	{
            ...
            if((vsb != null) && !vsbNeeded && (vsbPolicy != VERTICAL_SCROLLBAR_NEVER))
	    {
                ...
                if(vsbNeeded) adjustForVSB(true, availR, vsbR, vpbInsets, leftToRight);
            }
        }
	...
	if(viewport != null)
	{
                ...
                if(hsb != null && hsbPolicy == HORIZONTAL_SCROLLBAR_AS_NEEDED)
		{
                        ...
                        if((vsb != null) && !vsbNeeded && (vsbPolicy != VERTICAL_SCROLLBAR_NEVER))
			{
                ...
                if(oldHSBNeeded != hsbNeeded || oldVSBNeeded != vsbNeeded) viewport.setBounds(availR);
            }
        }
        ...
        if(rowHead != null) rowHead.setBounds(rowHeadR);
        if(colHead != null) colHead.setBounds(colHeadR);
        ...
        if(hsb != null){
            if(hsbNeeded){
                ...
                if(hleft!=null)  hleft.setVisible(false);
                if(hright!=null) hright.setVisible(false);
            }
        }

        if(lowerLeft != null)  lowerLeft.setBounds(leftToRight ? rowHeadR.x : vsbR.x, hsbR.y, leftToRight ? rowHeadR.width : vsbR.width, hsbR.height);
        if(lowerRight != null) lowerRight.setBounds(leftToRight ? vsbR.x : rowHeadR.x, hsbR.y, leftToRight ? vsbR.width : rowHeadR.width, hsbR.height);
        if(upperLeft != null)  upperLeft.setBounds(leftToRight ? rowHeadR.x : vsbR.x, colHeadR.y, leftToRight ? rowHeadR.width : vsbR.width, colHeadR.height);
        if(upperRight != null) upperRight.setBounds(leftToRight ? vsbR.x : rowHeadR.x, colHeadR.y, leftToRight ? vsbR.width : rowHeadR.width, colHeadR.height);
    }
