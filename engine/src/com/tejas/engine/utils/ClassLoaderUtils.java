...
public class ClassLoaderUtils
{
    ...
    {
	try { return getClassFromFile(file, className, _class).newInstance(); }
     ...
     * 
     * @return File filters (*.class, *.jar)
     * @since 0.2.0
     */
    public static FileFilter[] getFileFilters()
    {
	return new FileFilter[] { new FileNameExtensionFilter("Java files (*.class, *.jar)", "class", "jar") };
    }
	...
	if (classes.isEmpty()) throw new RuntimeException("Java classes not found in '" + file + "'");
     ...
     * @param file .class/.jar file
     * @param _class Reference to the class
     * @return List of found Java classes implementing/extending <code>_class</code>
     * @since 0.2.0
     */
...
//                ucl.close();
     ...
     * @param qualifiedName Fully qualified name of the class (<code>package.className</code>)
     * @return Java class
     * @since 0.2.0
     */
     ...
     * @return <code>String</code> array in which the first element is the package name (empty <code>String</code> means no package), and the second one is the class name
     * @since 0.2.3
     */
    public static String[] getPackageAndClassName(String fullyQualifiedClassName)
    {
        String packageName = "";
        String className;
