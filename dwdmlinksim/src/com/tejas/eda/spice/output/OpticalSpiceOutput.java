...
import com.tejas.eda.spice.analysis.optical.OpticalAnalysisEventListener;
 ...
 * @author owenbad
 */
public abstract class OpticalSpiceOutput implements OpticalAnalysisEventListener {
    ...
    public OpticalSpiceOutput(String title) {
        this.title = title;
    }
