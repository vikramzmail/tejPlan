 ...
 * @author owenbad
 */
public abstract class OpticalModelCard<I extends OpticalInstance, L extends Model> extends Card {

    protected FastMap<String, String> properties = FastMap.newInstance();
    protected String type;
    protected String name;
    public static final String OPTLINK_TYPE = "L";  //ss
    public static final String EDFA_TYPE = "A";
    public static final String NODE_TYPE = "R";	//adi
    public static final String DISP_TYPE = "D";  //ss
...
//    public static final String PMF_TYPE = "PMF";
    ...
    public OpticalModelCard(String cardString) throws ParserException {
        super(cardString);
        parse(cardString);
    }
