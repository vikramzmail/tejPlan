...
public class NodeCard extends OpticalInstanceCard {
	
	private String posNodeName;
	private String negNodeName;
	private String nodeLoss;
	...
	public NodeCard(String cardString) throws ParserException {
		this();
	...
	public String getnLoss() {
		return nodeLoss;
	}

	public void setnLoss(String NLOSS) {
		this.nodeLoss = NLOSS;
	}
	...
	public OpticalInstance createInstance(OpticalDeck deck) {
		NodeModelCard card = (NodeModelCard) deck.getModelCard(modelName);
        NodeInstance instance = card.createInstance();
        ...
        if(nodeLoss != null){
        	instance.setnLoss(parseDouble(nodeLoss));
        }
	...
	public void parse(String cardString) throws ParserException {
        ...
        modelName = elements[3];
            ...
            for (int i = 4; i < elements.length; i++) {
                if (elements[i].equalsIgnoreCase("NLOSS")) {
                    setnLoss(elements[++i]);
                } 
            }
        }
